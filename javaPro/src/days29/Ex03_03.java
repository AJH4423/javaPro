...
public class Ex03_03 {
	...
	public static void main(String[] args) {
		...
		// 2. 단순히 남자가 몇명이고 여자가 몇명인지?
		// maleStudent.size();
		// femaleStudent.size();
		
		Map<Boolean, Long> map2 = Stream.of(stuArr).collect(Collectors.partitioningBy(Student::isMale,Collectors.counting()));
		System.out.println(map2.get(true)); // 남자 : 8
		System.out.println(map2.get(false)); // 여자 : 10
		
		// 3. 성별 분할(구분)한 뒤에 1등 학생의 정보 출력.
		Map<Boolean, Optional<Student>> map3 = Stream.of(stuArr)
